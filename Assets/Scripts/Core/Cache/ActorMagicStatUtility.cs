...
{
    public static class ActorMagicStatUtility
    {
        ...
        public static void AddSkill(ref ActorSkillSet skills, sbyte skill, float value)
        {
            ...
            SetSkill(ref skills, kind, GetSkill(skills, kind) + value);
        }
        ...
        static float GetSkill(in ActorSkillSet skills, ActorSkillKind skill)
        {
            return skill switch
            {
                ...
                _ => throw new InvalidOperationException("[VVardenfell][Magic] Unknown actor skill kind."),
            };
        }
