...
namespace VVardenfell.Core.Cache
{
    ...
    public static class GameplayContentFile
    {
        ...
        static void WriteActorBodyPartArray(BinaryWriter w, ActorBodyPartDef[] values)
        {
            ...
            w.Write(count);
            for (int i = 0; i < count; i++)
                WriteActorBodyPart(w, values[i]);
        }

        static ActorBodyPartDef[] ReadActorBodyPartArray(BinaryReader r)
        {
            int count = r.ReadInt32();
            var values = new ActorBodyPartDef[count];
            for (int i = 0; i < count; i++)
                values[i] = ReadActorBodyPart(r);
            return values;
        }
        ...
        static void WritePathGridArray(BinaryWriter w, PathGridDef[] values)
        {
            ...
            w.Write(count);
            for (int i = 0; i < count; i++)
                WritePathGrid(w, values[i]);
        }

        static PathGridDef[] ReadPathGridArray(BinaryReader r)
        {
            int count = r.ReadInt32();
            var values = new PathGridDef[count];
            for (int i = 0; i < count; i++)
                values[i] = ReadPathGrid(r);
            return values;
        }
        ...
        static void WritePathGridPointArray(BinaryWriter w, PathGridPointDef[] values)
        {
            ...
            w.Write(count);
            for (int i = 0; i < count; i++)
                WritePathGridPoint(w, values[i]);
        }

        static PathGridPointDef[] ReadPathGridPointArray(BinaryReader r)
        {
            int count = r.ReadInt32();
            var values = new PathGridPointDef[count];
            for (int i = 0; i < count; i++)
                values[i] = ReadPathGridPoint(r);
            return values;
        }
        ...
        static void WritePathGridConnectionArray(BinaryWriter w, PathGridConnectionDef[] values)
        {
            ...
            w.Write(count);
            for (int i = 0; i < count; i++)
                WritePathGridConnection(w, values[i]);
        }

        static PathGridConnectionDef[] ReadPathGridConnectionArray(BinaryReader r)
        {
            int count = r.ReadInt32();
            var values = new PathGridConnectionDef[count];
            for (int i = 0; i < count; i++)
                values[i] = ReadPathGridConnection(r);
            return values;
        }
        ...
        static void WritePathGridNavigationNodeArray(BinaryWriter w, PathGridNavigationNodeDef[] values)
        {
            ...
            w.Write(count);
            for (int i = 0; i < count; i++)
                WritePathGridNavigationNode(w, values[i]);
        }

        static PathGridNavigationNodeDef[] ReadPathGridNavigationNodeArray(BinaryReader r)
        {
            int count = r.ReadInt32();
            var values = new PathGridNavigationNodeDef[count];
            for (int i = 0; i < count; i++)
                values[i] = ReadPathGridNavigationNode(r);
            return values;
        }
        ...
        static void WritePathGridNavigationEdgeArray(BinaryWriter w, PathGridNavigationEdgeDef[] values)
        {
            ...
            w.Write(count);
            for (int i = 0; i < count; i++)
                WritePathGridNavigationEdge(w, values[i]);
        }

        static PathGridNavigationEdgeDef[] ReadPathGridNavigationEdgeArray(BinaryReader r)
        {
            int count = r.ReadInt32();
            var values = new PathGridNavigationEdgeDef[count];
            for (int i = 0; i < count; i++)
                values[i] = ReadPathGridNavigationEdge(r);
            return values;
        }
        ...
        static void WritePathGridNavigationPortalArray(BinaryWriter w, PathGridNavigationPortalDef[] values)
        {
            ...
            w.Write(count);
            for (int i = 0; i < count; i++)
                WritePathGridNavigationPortal(w, values[i]);
        }

        static PathGridNavigationPortalDef[] ReadPathGridNavigationPortalArray(BinaryReader r)
        {
            int count = r.ReadInt32();
            var values = new PathGridNavigationPortalDef[count];
            for (int i = 0; i < count; i++)
                values[i] = ReadPathGridNavigationPortal(r);
            return values;
        }
        ...
        static void WritePathGridNavigationAbstractEdgeArray(BinaryWriter w, PathGridNavigationAbstractEdgeDef[] values)
        {
            ...
            w.Write(count);
            for (int i = 0; i < count; i++)
                WritePathGridNavigationAbstractEdge(w, values[i]);
        }

        static PathGridNavigationAbstractEdgeDef[] ReadPathGridNavigationAbstractEdgeArray(BinaryReader r)
        {
            int count = r.ReadInt32();
            var values = new PathGridNavigationAbstractEdgeDef[count];
            for (int i = 0; i < count; i++)
                values[i] = ReadPathGridNavigationAbstractEdge(r);
            return values;
        }
        ...
        static void WritePathGridNavigationNeighborArray(BinaryWriter w, PathGridNavigationNeighborDef[] values)
        {
            ...
            w.Write(count);
            for (int i = 0; i < count; i++)
                WritePathGridNavigationNeighbor(w, values[i]);
        }

        static PathGridNavigationNeighborDef[] ReadPathGridNavigationNeighborArray(BinaryReader r)
        {
            int count = r.ReadInt32();
            var values = new PathGridNavigationNeighborDef[count];
            for (int i = 0; i < count; i++)
                values[i] = ReadPathGridNavigationNeighbor(r);
            return values;
        }
        ...
        static void WriteActorAiPackageArray(BinaryWriter w, ActorAiPackageDef[] values)
        {
            ...
            w.Write(count);
            for (int i = 0; i < count; i++)
                WriteActorAiPackage(w, values[i]);
        }

        static ActorAiPackageDef[] ReadActorAiPackageArray(BinaryReader r)
        {
            int count = r.ReadInt32();
            var values = new ActorAiPackageDef[count];
            for (int i = 0; i < count; i++)
                values[i] = ReadActorAiPackage(r);
            return values;
        }
        ...
        static void WriteActorTravelDestinationArray(BinaryWriter w, ActorTravelDestinationDef[] values)
        {
            ...
            w.Write(count);
            for (int i = 0; i < count; i++)
                WriteActorTravelDestination(w, values[i]);
        }

        static ActorTravelDestinationDef[] ReadActorTravelDestinationArray(BinaryReader r)
        {
            int count = r.ReadInt32();
            var values = new ActorTravelDestinationDef[count];
            for (int i = 0; i < count; i++)
                values[i] = ReadActorTravelDestination(r);
            return values;
        }
